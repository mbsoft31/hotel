<div class="relative">
    <div class="relative w-full max-w-3xl mx-auto -mt-10">
        <div class="bg-white w-full px-8 pt-6 pb-8 space-y-4 rounded-md shadow">
            ...
            <x-input.text id="search" placeholder="Search for name, address" wire:model="search" class="w-full text-xl border border-gray-300 focus:border-pink-300 outline-none focus:ring-offset-1 focus:ring-2 focus:ring-pink-500"/>
        </div>
    </div>
